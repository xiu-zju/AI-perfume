...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AI香水', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '香水行业的新潮', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'itp.xiu-zju.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '香水,AI', // 网站关键词 英文逗号隔开
